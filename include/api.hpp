...
namespace uspe
{
  ...
  const json::json messages{{"messages",
                             {ratio::executor::new_executor_message,
                              ...
                              coco::types_message,
                              coco::new_type_message,
                              coco::updated_type_message,
                              coco::deleted_type_message,
                              coco::items_message,
                              coco::new_item_message,
                              coco::updated_item_message,
                              coco::deleted_item_message,
                              coco::data_message,
                              {"connect",
                               {"payload",
                                {{"type", "object"},
  ...
  const json::json users_path{{"post",
                               {{"summary", "Create User"},
  ...
  const json::json users_id_path{{"put",
                                  {{"summary", "Update User"},
  ...
  inline json::json make_async_api() noexcept
  {
    json::json async_api{
        ...
        {"operations",
         {{"connect",
           {{"summary", "Connect"},
            {"description", "Connect to the USPE WebSocket API"},
            {"action", "send"},
            {"channel", {"$ref", "#/channels/uspe"}},
            {"messages", std::vector<json::json>{{"$ref", "#/channels/uspe/messages/connect"}}}}},
          {"connections",
           {{"summary", "Connections"},
